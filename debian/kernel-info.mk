...
KERNEL_BOOTIMAGE_CMDLINE = root=/dev/ram console=tty0 console=ttyS0,921600n1 vmalloc=400M slub_debug=OFZPU page_owner=on swiotlb=noforce androidboot.hardware=mt6765 maxcpus=8 loop.max_part=7 firmware_class.path=/vendor/firmware has_battery_removed=0 androidboot.verifiedbootstate=orange bootopt=64S3,32N2,64N2 androidboot.selinux=permissive buildvariant=user androidboot.atm=enable androidboot.meta_log_disable=0 androidboot.dtbo_idx=0 printk.disable_uart=1 androidboot.lcm_wp_x=0.295 androidboot.lcm_wp_y=0.318 bootprof.pl_t=1299 bootprof.lk_t=2694 bootprof.logo_t=926 boot_reason=0 androidboot.serialno=0218d26d7d29 androidboot.uniqueno=a47425b6dc3252b0a41c88c1fa6f18d70218d26d androidboot.rpmb_flag=1 androidboot.bootreason=keypad board_id=S98507AE1 bd_ext5=1 bd_ext6=0 bd_vol=294433 hw_id=MP hw_id_vol=1218750 androidboot.hwversion=2.3.0 androidboot.hwc=CN androidboot.hwlevel=3.0 gpt=1 usb2jtag_mode=0 mrdump_ddrsv=yes mrdump_cb=0x10e800,0x1400 droidian.lvm.prefer
...
DEVICE_FULL_NAME = Xiaomi Redmi 6
...
# Defconfig to use
KERNEL_DEFCONFIG = certus.defconfig
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/mediatek/certus.dts
